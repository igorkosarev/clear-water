...
const HERO_PARTICLES: HeroParticle[] = [
  { x:  5, y: 82, size:  5, dur:  8.0, delay: 0.0, dx:  3, dy: -28, blue: true  },
  { x: 15, y: 65, size: 12, dur: 10.0, delay: 1.5, dx: -5, dy: -20, blue: false },
  { x: 23, y: 90, size:  4, dur:  7.0, delay: 0.8, dx:  8, dy: -32, blue: true  },
  { x: 38, y: 72, size: 18, dur: 13.0, delay: 2.0, dx: -3, dy: -15, blue: true  },
  { x: 50, y: 88, size:  6, dur:  9.0, delay: 0.3, dx:  5, dy: -24, blue: false },
  { x: 62, y: 58, size: 10, dur: 11.0, delay: 1.2, dx: -7, dy: -18, blue: true  },
  { x: 74, y: 78, size:  8, dur:  8.5, delay: 2.5, dx:  4, dy: -26, blue: false },
  { x: 84, y: 68, size: 14, dur: 10.5, delay: 0.5, dx: -4, dy: -22, blue: true  },
  { x: 93, y: 42, size:  5, dur:  7.5, delay: 1.8, dx: -6, dy: -28, blue: false },
  { x:  9, y: 32, size:  9, dur:  9.5, delay: 1.0, dx:  6, dy: -16, blue: true  },
  { x: 30, y: 48, size:  6, dur:  8.0, delay: 3.0, dx: -4, dy: -22, blue: false },
  { x: 48, y: 22, size: 20, dur: 14.0, delay: 0.2, dx:  2, dy: -10, blue: true  },
  { x: 68, y: 38, size:  7, dur:  9.0, delay: 2.2, dx: -8, dy: -20, blue: false },
  { x: 88, y: 88, size: 11, dur: 11.5, delay: 1.5, dx:  5, dy: -26, blue: true  },
  { x: 20, y: 18, size:  4, dur:  6.5, delay: 0.7, dx:  7, dy: -32, blue: false },
]
