...
import { MapPin, AlertTriangle, Search, Zap, Target, Biohazard, Dna, Worm, Droplets, Beaker, TestTube, Leaf, Gem } from 'lucide-react'
...
const CONTAMINANT_ICONS: Record<string, LucideIcon> = {
  bacteria:     Biohazard,
  viruses:      Dna,
  protozoa:     Worm,
  turbidity:    Droplets,
